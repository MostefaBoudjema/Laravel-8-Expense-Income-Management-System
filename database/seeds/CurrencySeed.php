...
class CurrencySeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 1, 'title' => 'DZD', 'symbol' => 'DA', 'money_format_thousands' => ' ', 'money_format_decimal' => '.', 'created_by_id' => 1],
            ...
            ['id' => 4, 'title' => 'USD', 'symbol' => '$', 'money_format_thousands' => ',', 'money_format_decimal' => '.', 'created_by_id' => 1],
